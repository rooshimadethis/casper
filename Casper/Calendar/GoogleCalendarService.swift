...
private let calendarLog = Logger(subsystem: "com.rooshi.casper", category: "calendar")
    ...
    func start() -> UInt16? {
        ...
        DispatchQueue.global(qos: .userInitiated).async { [self] in
            ...
            let html = authCode != nil
                ? "<html><body style='font-family:system-ui;text-align:center;padding:60px'><h2>Connected to Casper!</h2><p>You can close this tab.</p></body></html>"
                : "<html><body style='font-family:system-ui;text-align:center;padding:60px'><h2>Something went wrong</h2><p>Please try again from Casper settings.</p></body></html>"

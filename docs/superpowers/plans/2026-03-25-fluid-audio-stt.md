...
**Goal:** Add a unified speech model picker that routes internally to WhisperKit or FluidAudio so Casper can offer Parakeet v3 without exposing backend details.
...
**Files:**
- Create: `Casper/Transcription/SpeechModelCatalog.swift`
- Test: `CasperTests/SpeechModelCatalogTests.swift`
...
**Files:**
- Create: `Casper/Transcription/SpeechTranscriptionBackend.swift`
- Modify: `Casper/Transcription/ModelManager.swift`
- Test: `CasperTests/SpeechBackendRoutingTests.swift`
...
**Files:**
- Create: `Casper/Transcription/WhisperKitSpeechBackend.swift`
- Modify: `Casper/Transcription/WhisperTranscriber.swift`
- Modify: `Casper/AppState.swift`
- Test: `CasperTests/WhisperBackendTests.swift`
...
**Files:**
- Modify: `project.yml`
- Modify: `Casper.xcodeproj/project.pbxproj`
- Modify: `Casper.xcodeproj/project.xcworkspace/xcshareddata/swiftpm/Package.resolved`
- Create: `Casper/Transcription/FluidAudioSpeechBackend.swift`
- Test: `CasperTests/FluidAudioBackendTests.swift`
...
**Files:**
- Modify: `Casper/ModelInventory.swift`
- Modify: `Casper/UI/ModelInventoryViews.swift`
- Modify: `Casper/UI/OnboardingWindow.swift`
- Modify: `Casper/UI/SettingsWindow.swift`
- Test: `CasperTests/RuntimeModelInventoryTests.swift`

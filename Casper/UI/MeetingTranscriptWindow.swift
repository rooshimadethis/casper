...
struct MeetingRootView: View {
    ...
    private func sendWhitelistRequest(via transport: WhitelistTransport) {
        ...
        let to = "casper@factorial.cc"
        let subject = "Whitelist request for Casper"
...
private struct ConsentDialogView: View {
    ...
    private static let consentMessage = "I'm using 🌶️ Casper, a completely private AI note taker. Nothing leaves my computer and all AI models are done on device."

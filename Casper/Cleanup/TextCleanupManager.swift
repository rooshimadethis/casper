...
final class TextCleanupManager: ObservableObject, TextCleaningManaging {
    ...
    private static let systemPromptSentinel = "<|casper-system-prefill-split|>"
    private static let userInputSentinel = "<|casper-user-prefill-split|>"
    ...
    static var modelsDirectory: URL {
        ...
        return appSupport.appendingPathComponent("Casper/models", isDirectory: true)
    }

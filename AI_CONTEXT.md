# Ghost Pepper AI Context

This document contains canonical, project-specific context for developers and AI agents working on Ghost Pepper.
...
* **Location:** `GhostPepper/Transcription/`
* **Mechanisms:**
...
* **Location:** `GhostPepper/Cleanup/` and `GhostPepper/QA/`
* **Models Cache:** `~/Library/Application Support/GhostPepper/models/`
* **Configured Models:**
...
* **Location:** `GhostPepper/Context/` and `GhostPepper/Reader/`
* **Mechanisms:**
...
* **Location:** `GhostPepper/Input/TextPaster.swift`
* **Mechanisms:**
...
* **Details:** Automatic opening of the `MeetingTranscriptWindow` on app launch (or upon onboarding completion) has been **disabled** (modified in `GhostPepperApp.swift`).
...
* **Location:** [DesktopAgentBridge.swift](file:///Users/rooshi/Documents/programming/mac/ghost-pepper/GhostPepper/QA/DesktopAgentBridge.swift)
* **Design Pattern:**
